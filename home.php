...
<html lang="en">
  ...
  <body>
    ...
    <main class="container-fluid row m-auto  bg-warning "><h1 class="text-transperant text-center">Our Achivement
</h1>
        <div class=" col-4">
            <p class="text-center pt-2">
            <i class="fa-solid fa-graduation-cap h-50"></i>
                </p>
            <h2 class="text-center text-transperant"> Education</h2>
            <p >The school has a highly educated, well trained and competent staff. The first batch of students appeared for S.S.C. examination in March 1984 and our results were 100%. More than half the number of students secured above 75%. Since then the school has maintained a glorious tradition of excellent results.<br> <a class="text-transperant" href="registration.php ">Read More....</a></p>
        </div>
        <div class=" col-4">
            <p class="text-center pt-2">
                
            </p>
            <h2 class="text-center text-transperant">Sports </h2>
...
<br> <a class="bg-transperant" href="registration.php">Read More....</a></p>
        </div>
        <div class=" col-4">
            <p class="text-center pt-2">
                
            </p>
            <h2 class="text-center text-transperant">Others
</h2>
...
<br> <a class="bg-transperant" href="registration.php ">Read More....</a></p>
    ...
    <nav class="container-fluid row m-auto text-center  bg-warning"><h1  class="text-transperant ">Objectives
</h1>
...
<h1  class="text-transperant ">Events in 2023-24</h1></div>
...
<footer class="container-fluid row m-auto text-center  bg-warning">
<br>
<br>
</footer>
<script>
